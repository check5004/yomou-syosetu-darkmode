...
- [x] 紹介イラスト（440×280）を作成し、[画像の権利・掲載方法を検証](docs/STORE_ASSET_VALIDATION.md)する。
- [x] 実設定画面と架空デモを使い、1280×800のスクリーンショット候補5枚を作成する。
- [ ] ストア向けスクリーンショット（1280×800）の試作から提出画像を確定する。実設定画面を優先し、架空デモはその旨を明示する。
