...
適用範囲は **`yomou.syosetu.com` と `ncode.syosetu.com`** です。同じドメインのトップページや作品情報にも共通の配色を適用します。作者マイページ、ログイン画面、感想サイト、成人向けの別サイトは対象外です。
...
- 対応する2ドメインで、同梱したCSSとJavaScriptを実行します。
