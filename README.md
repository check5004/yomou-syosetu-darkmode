...
実サイトの保存済みページから撮影し、作品名・作者名・あらすじなどの文字をぼかしています。サイトのロゴ・サイト名・固有の文言・アイコンは、不透明な灰色の図形で覆っています。ぼかしと図形の位置は左右で同じです。撮影時は広告を省略しています。これらは掲載画像だけの加工で、本拡張機能の機能ではありません。[画像の作成方法](docs/STORE_ASSET_VALIDATION.md)
